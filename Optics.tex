...
\begin{figure}[htbp]
	...
	\begin{minipage}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{spherical-aberration-curve-1.pdf}
	...
	\begin{minipage}[t]{0.48\textwidth}
		\centering
		\includegraphics[width=1\textwidth]{spherical-aberration-curve-2.pdf}
...
\begin{table}[htbp]
	...
	\begin{tabular}{c|c|c|c|c|c|c|c|c}
		\hline
		\multirow{2}{*}{} & \multicolumn{2}{c|}{$-\infty\leqslant L<\dfrac{(n'+n)r}{n}$} & \multicolumn{2}{c|}{$\dfrac{(n'+n)r}{n}<L<r$} & \multicolumn{2}{c|}{$r<L<0$} & \multicolumn{2}{c}{$0<L\leqslant\infty$}\\
		\cline{2-9} 
		& $n'>n$ & $n'<n$ & $n'>n$ & $n'<n$ & $n'>n$ & $n'<n$ & $n'>n$ & $n'<n$\\
		\hline
		$\sin I-\sin I'$& $-$发散 & $+$会聚 & $-$发散 & $+$会聚 & $+$会聚 & $-$发散 & $-$发散 & $+$会聚\\
		\hline
		$\delta L'$& $+$正球差 & $-$负球差 & $-$负球差 & $+$正球差 & $-$负球差 & $+$正球差 & $+$正球差 & $-$负球差\\
		\hline
	\end{tabular}}
